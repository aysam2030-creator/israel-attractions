...
const AttractionMarker = memo(({
  ...
  const eventHandlers = useMemo(() => ({ click: () => onSelect(attraction) }), [attraction, onSelect]);

  return (
    <Marker position={[attraction.lat, attraction.lng]} icon={icon} eventHandlers={eventHandlers}>
      <Popup>
        <div className="popup">
