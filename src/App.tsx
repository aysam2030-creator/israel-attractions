...
// ⚡ Bolt: Cache L.DivIcon instances to prevent severe DOM thrashing and excessive GC overhead.
// React-Leaflet recreates the marker elements on every render if a new icon reference is passed.
