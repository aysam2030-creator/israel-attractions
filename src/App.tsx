...
// ⚡ Bolt Optimization: Cache Leaflet icons to prevent severe DOM thrashing on re-renders
...
// ⚡ Bolt Optimization: Extract pathOptions to avoid breaking React-Leaflet memoization
