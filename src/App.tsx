...
// Memoize icon creation to prevent severe DOM thrashing from react-leaflet
// recreating markers on every render when the icon reference changes.
...
// Stable reference to prevent polyline from being recreated
