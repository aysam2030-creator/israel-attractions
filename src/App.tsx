...
// ⚡ Bolt: Cache L.divIcon instances to prevent DOM thrashing when markers re-render
...
// ⚡ Bolt: Extract pathOptions to prevent Polyline re-rendering on every App state change
