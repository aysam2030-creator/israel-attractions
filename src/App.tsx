...
// Cache L.DivIcon instances to prevent React Leaflet from tearing down and
// rebuilding DOM nodes for map markers on every render when object references change.
...
// Extract path options to a constant to maintain a stable reference
// and prevent React Leaflet from recalculating path properties on every render.
