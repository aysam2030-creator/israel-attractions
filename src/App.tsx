...
// Optimization: Extract the Map Marker into a memoized component.
// This prevents inline `eventHandlers` from creating new object references
// on every render, which causes react-leaflet to re-render the Leaflet marker internals unnecessarily.
const MapMarker = memo(({ a, color, isTrip, step, lang, setSelected }: {
  a: Attraction,
  color: string,
  isTrip: boolean,
  step?: number,
