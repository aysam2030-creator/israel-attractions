...
// Optimized: Cache pin icons to prevent Leaflet from recreating them on every render
// React-Leaflet is sensitive to object reference changes, causing severe DOM thrashing.
...
// Stable reference for polyline options to prevent react-leaflet re-renders
...
export default function App() {
  ...
  // Optimized: Memoize trip path to prevent array recreation on every render
