...
// Prevent DOM thrashing and excessive Leaflet instance creation
// by caching the marker icons.
...
// Prevent Polyline re-renders by maintaining a stable reference for path options
...
export default function App() {
  ...
  // Prevent Polyline from re-rendering on every App render by memoizing the path coordinates array
