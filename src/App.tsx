...
// ⚡ Bolt Optimization: Cache Leaflet icons to prevent DOM thrashing
// Impact: Prevents React-Leaflet from recreating the icon on every render,
// eliminating severe DOM thrashing and significantly improving map performance.
...
// ⚡ Bolt Optimization: Extract static path options to prevent re-renders
