...
// ⚡ Bolt: Cache custom Leaflet icons to prevent DOM thrashing on every re-render.
// Leaflet compares object references for Icons. Creating new ones triggers
// a full removal and re-insertion of marker DOM nodes, which destroys performance.
...
// ⚡ Bolt: Extract constant polyline properties outside the component
// to prevent Leaflet from unnecessarily updating path options on render.
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize the polyline path array to keep a stable reference.
  // Passing inline arrays to Leaflet properties causes the element to redraw on every render.
