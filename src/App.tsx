...
// ⚡ Bolt: Cache L.DivIcon instances. Leaflet updates DOM if icon object reference changes.
...
// ⚡ Bolt: Static polyline path options to provide a stable reference and prevent re-renders
...
// ⚡ Bolt: Memoize Marker and eventHandlers to prevent react-leaflet DOM thrashing
const MemoizedMarker = memo(function MemoizedMarker({ a, icon, lang, setSelected }: MemoizedMarkerProps) {
  const eventHandlers = useMemo(() => ({ click: () => setSelected(a) }), [setSelected, a]);
  return (
    <Marker
