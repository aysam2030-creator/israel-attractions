...
// ⚡ Bolt: Cache dynamically generated Map icons to prevent DOM thrashing and React hook violations during re-renders.
...
// ⚡ Bolt: Extracted memoized Marker component to prevent bailing out failure.
// Passing evaluated primitives (`isTrip`, `step`) and stable setter function (`setSelected`).
...
const MapMarker = memo(function MapMarker({ a, lang, isTrip, step, setSelected }: MapMarkerProps) {
  return (
    <Marker
