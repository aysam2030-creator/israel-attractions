...
// ⚡ Bolt: Cache Leaflet icons to prevent severe DOM thrashing on re-renders
...
// ⚡ Bolt: Extract pathOptions to keep object reference stable and avoid re-renders
...
export default function App() {
  ...
  // ⚡ Bolt: Memoize trip path array to prevent unnecessary Polyline updates
