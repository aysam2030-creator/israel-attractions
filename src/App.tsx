...
// ⚡ Bolt Optimization: Cache Leaflet icons to prevent DOM thrashing and memory allocation on every render
...
// ⚡ Bolt Optimization: Memoize the Marker component to prevent React-Leaflet from destroying and recreating
// the DOM node for every marker on parent state updates (significantly improves map rendering performance).
